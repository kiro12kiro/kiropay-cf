document.addEventListener("DOMContentLoaded", () => {
    ...
    (function setupAdminPanel() {
        let currentSearchedUser = null; // المستخدم الذي تم اختياره للتعديل الفردي
        ...
        // --- فانكشن تعديل الرصيد الجماعي 🛑🛑 (الهدف المطلوب) 🛑🛑 ---
            ...
            try {
                ...
                if (response.ok) {
                    ...
                    if (currentSearchedUser && selectedUsersForMassUpdate.includes(currentSearchedUser.email)) {
                        refreshUserData(); // تحديث اللوحة الفردية
                    }
