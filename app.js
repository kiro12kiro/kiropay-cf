 ...
 * يجب أن تكون هذه الدالة محمية (لم يتم تضمين التحقق من صلاحيات الأدمن هنا)
 */
export async function onRequestPost(context) {
    try {
        ...
        // 1. تحقق سريع من صلاحيات الأدمن (أساسي جداً)
        // هذا التحقق ضروري لمنع أي مستخدم عادي من إرسال طلبات مكافأة
        // بما أن دالة getAuthUser غير متوفرة، سنعتمد على أن التحقق من الـ role تم في الكود الذي يستدعي الـ API
