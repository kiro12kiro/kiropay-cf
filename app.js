document.addEventListener("DOMContentLoaded", () => {
  ...
  // 🛑🛑 الحل النهائي للمشكلة (فرض الحالة الأولية الصحيحة عند فتح الصفحة) 🛑🛑
  ...
  avatarOverlayLabel.style.display = "none"; // اخفاء زرار تغيير الصورة
  // 🛑🛑 نهاية الحل 🛑🛑
